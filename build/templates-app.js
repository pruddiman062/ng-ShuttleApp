angular.module('templates-app', ['about/about.tpl.html', 'home/home.tpl.html', 'login/login.tpl.html', 'manage/addschedule.tpl.html', 'manage/clockpicker.tpl.html', 'manage/deletemodal.tpl.html', 'manage/manage.shuttle.tpl.html', 'manage/manage.tpl.html', 'manage/overview.tpl.html', 'manage/schedule.tpl.html', 'manage/shuttlemodal.tpl.html']);
...
angular.module("login/login.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("login/login.tpl.html",
    "   <link rel=\"stylesheet\" href=\"assets/template/cover.css\" type=\"text/css\" />\n" +
    ...
    "            <div class=\"inner\">\n" +
    "              <h3 class=\"\">HawkStop Administration Panel</h3>\n" +
    "            </div>\n" +
    "          </div>\n" +
    "\n" +
    "          <div id=\"container\" class=\"inner cover\" ng-controller=\"LoginCtrl\">\n" +
    ...
    "		          </label>\n" +
    "		        </div>\n" +
    "		        <button class=\"btn btn-lg btn-primary btn-block\" ng-click=\"login(user)\">Sign in</button>\n" +
    "		      </form>\n" +
    "          </div>\n" +
    "\n" +
    "          <div class=\"mastfoot\">\n" +
...
angular.module("manage/addschedule.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("manage/addschedule.tpl.html",
    "<div style=\"padding-top:15px; padding-bottom:15px;\">\n" +
    "	<div class=\"row\">\n" +
    "		<div class=\"col-sm-3\"></div>\n" +
    "		<div class=\"col-sm-3\"><h4>#</h4></div>\n" +
    "		<div class=\"col-sm-3\"><h4>Time</h4></div>\n" +
    "		<div class=\"col-sm-3\"><input type=\"hidden\" ng-model='newTime'/>{{newTime}}<button class='btn btn-sm btn-primary' ng-click=\"addTime()\"><strong>Add</strong></button>&nbsp;<button class='btn btn-sm btn-primary' ng-click=\"close()\"><strong>Close</strong></button></div>\n" +
    "	</div>\n" +
    "	<div>\n" +
    "		<div class=\"row\" style=\"padding-top:10px; padding-bottom:10px;\">\n" +
    "			<div class=\"col-sm-3\"></div>\n" +
    "			<div class=\"col-sm-3\"></div>\n" +
    "			<div class=\"col-sm-3 time\">{{time[0]}}</div>\n" +
    "			<div class=\"col-sm-3\">\n" +
    "				<button id=\"1\" class=\"btn btn-sm btn-primary\">Edit</button>\n" +
    "	    		<button id=\"0\" class=\"btn btn-sm btn-primary\"><strong>x</strong></button>\n" +
    "	    	</div>\n" +
    "		</div>\n" +
    "	</div>\n" +
    "</div>");
...
angular.module("manage/clockpicker.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("manage/clockpicker.tpl.html",
...
angular.module("manage/deletemodal.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("manage/deletemodal.tpl.html",
    "<div class=\"row padding-modal\">\n" +
    "    <div class=\"col-md-12 text-center\"><h3>Are you sure you want to delete this stop?</h3></div>\n" +
    "    <div class=\"col-md-12 text-center\"><button class=\"btn btn-md btn-primary\" ng-click=\"yes()\">Yes</button> <button class=\"btn btn-md btn-primary\" ng-click=\"no()\">No</button></div>\n" +
    "</div>");
}]);

angular.module("manage/manage.shuttle.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("manage/manage.shuttle.tpl.html",
    "\n" +
    "<div id=\"lowerPane\">\n" +
    "	<h2 class=\"sub-header\"> Stops: </h2>  \n" +
    "	\n" +
    ...
    "	        <th>Latitude</th>\n" +
    "	        <th>Longitude</th>\n" +
    "	        <th><button class=\"btn btn-sm btn-primary\" ng-click=\"add()\">Add</button></th>\n" +
    "	      </tr>\n" +
    "	    </thead>\n" +
    "	    <tbody>\n" +
    ...
    "				<td>{{stop[2][0]}}</td>\n" +
    "				<td>{{stop[2][1]}}</td>\n" +
    "				<td><button class=\"btn btn-sm btn-primary\" ng-click=\"edit()\">Edit</button> <button class=\"btn btn-sm btn-primary\" ng-click=\"schedule()\">Edit Schedule</button> <button class=\"btn btn-sm btn-primary\" ng-click=\"deleteStop()\"><strong>x</strong></button></td></tr>\n" +
    "			</div>\n" +
    "	    </tbody>\n" +
    "	  </table>\n" +
    "	</div>\n" +
...
angular.module("manage/manage.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("manage/manage.tpl.html",
    ...
    "            <span class=\"icon-bar\"></span>\n" +
    "          </button>\n" +
    "          <a class=\"navbar-brand\" href=\"#\">HawkStop</a>\n" +
    "        </div>\n" +
    ...
    "            <li class=\"active\"><a id=\"overview\" ui-sref=\"manage\">Overview</a></li>\n" +
    "            <li><a ui-sref=\".shuttle\" ng-click=\"showStops($event, 1)\">Manage Schedule</a></li>\n" +
    "            <li><a ui-sref=\"#\">Administrators</a></li>\n" +
    "            <li><a ui-sref=\"#\">Export Schedule</a></li>\n" +
    "          </ul>\n" +
    "          <ul class=\"nav nav-sidebar\">\n" +
    "            <li><a ui-sref=\"#\">Shuttle Locations</a></li>\n" +
    "            <li><a ui-sref=\"#\">User Reports</a></li>\n" +
    "          </ul>\n" +
    "        </div>\n" +
    ...
    "                 <h2>Bristol</h2>\n" +
    "                 <span class=\"text-muted\"><a id=\"Bristol\" href=\"#\" ng-click=\"showStops(false, 1)\">Manage</a></span>\n" +
    "               </div>\n" +
    "               <div class=\"col-xs-6 col-sm-3 placeholder\">\n" +
    "                 <h2>Campus</h2>\n" +
    "                 <span class=\"text-muted\"><a id=\"Campus\" href=\"#\" ng-click=\"showStops(false, 2)\">Manage</a></span>\n" +
    "               </div>\n" +
    "               <div class=\"col-xs-6 col-sm-3 placeholder\">\n" +
    "                 <h2>Bay Point</h2>\n" +
    "                 <span class=\"text-muted\"><a id=\"Bay Point\" href=\"#\" ng-click=\"showStops(false, 3)\">Manage</a></span>\n" +
    "               </div>\n" +
    "            </div>\n" +
    "            <div ui-view=\"sub\"></div>\n" +
    "        </div>\n" +
    "      </div>\n" +
    "    </div>\n" +
    "<link rel=\"stylesheet\" href=\"assets/template/dashboard.css\" type=\"text/css\" />");
}]);

angular.module("manage/overview.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("manage/overview.tpl.html",
    "<h1 class=\"page-header\">Dashboard</h1>\n" +
    "\n" +
    "<div class=\"row\">\n" +
    "</div>");
...
angular.module("manage/schedule.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("manage/schedule.tpl.html",
    "<div style=\"padding-top:15px; padding-bottom:15px;\">\n" +
    "	<div class=\"row\">\n" +
    "		<div class=\"col-sm-3\"></div>\n" +
    "		<div class=\"col-sm-3\"><h4>#</h4></div>\n" +
    "		<div class=\"col-sm-3\"><h4>Time</h4></div>\n" +
    "		<div class=\"col-sm-3\"><button class='btn btn-sm btn-primary' ng-click=\"addTime()\"><strong>Add</strong></button>&nbsp;<button class='btn btn-sm btn-primary' ng-click=\"close()\"><strong>Close</strong></button></div>\n" +
    "	</div>\n" +
    "	<div ng-repeat=\"time in times\">\n" +
    "		<div class=\"{{($index%2) === 1 ? 'row-striped row': 'row-estriped row'}}\" style=\"padding-top:10px; padding-bottom:10px;\">\n" +
    "			<div class=\"col-sm-3\"></div>\n" +
...
angular.module("manage/shuttlemodal.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("manage/shuttlemodal.tpl.html",
    ...
    "        <tbody>\n" +
    "    		<tr>\n" +
    "    			<td><input type=\"hidden\" name=\"\" ng-model=\"form.stop.id\"/></td>\n" +
    "    			<td><input type=\"text\" name=\"\" ng-model=\"form.stop.name\" value=\"{{stop[0]}}\"/></td>\n" +
    "    			<td><input type=\"text\" name=\"\" ng-model=\"form.stop.lat\" value=\"{{stop[2][0]}}\"/></td>\n" +
    "    			<td><input type=\"text\" name=\"\" ng-model=\"form.stop.long\" value=\"{{stop[2][1]}}\"/></td>\n" +
    "    			<td><button class=\"btn btn-sm btn-primary\" ng-click=\"save(form)\">Save</button> <button class=\"btn btn-sm btn-primary\" ng-click=\"close();\">Close</button></td>\n" +
    "    		</tr>\n" +
    "        </tbody>\n" +
    "    </table>\n" +
    "</div>");
